###########################################################
# When we delete a save file we should also delete the secondary save file!
###########################################################

## Inject at 0x8019ce08

## CONSTANTS
delete_profile=0x802bf4f4
...
# Check against the original delete call, so we dont crash if secondary doesnt exist.
cntlzw r0, r19
